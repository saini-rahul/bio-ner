...
bottom_frame = Frame(root, bg="green", width=600, height = 500)
...
listbox_word = Listbox(bottom_frame, width=50, height=30)
listbox_word.grid (row=1, column=0)
listbox_token = Listbox(bottom_frame, width=50, height=30)
